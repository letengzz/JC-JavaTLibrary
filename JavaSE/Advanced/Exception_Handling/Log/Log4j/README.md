...
Log4j是一个组件化设计的日志系统。Log4j是一种非常流行的日志框架，最新版本是2.x。

**Log4j架构**：

![image-20221012184839911](D:/Data/typora/photo/image-20221012184839911.png)
...
因为Commons Logging会自动发现并使用Log4j，将`commons-logging-1.2.jar`也放到`classpath`中。
